...
public class FuncionarioController {
    ...
    private int proximoId; // Gerenciador de IDs únicos

    public FuncionarioController() {
        this.arquivoController = new ArquivoController();
        this.funcionarios = arquivoController.carregarFuncionarios(); // Carrega funcionários do arquivo
...
>>>>>>> 08ae04ec49415e3cd5b60ea039fe07f2f7ea8a3b
